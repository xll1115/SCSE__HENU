...
​	 这个项目是我做的一个LLM项目，有许多不规范的地方还请大家多多见谅。希望对有帮助的同学们，也能够给我star一下啦！
...
Agent是基于[ReAct](https://arxiv.org/abs/2210.03629)范式实现，其核心在于通过整合**推理与行动**的功能，以增强模型在解决复杂任务时的能力，具体包括
...
[scse-基于llm的智慧校园超级入口](https://www.bilibili.com/video/BV1vHYFeeEN6/)
...
@misc{SCSE,
    title={SCSE},
    author={SCSE},
    url={https://github.com/626394316/SCSE},
    year={2024}
}
```
